      ...
      <div className="container mx-auto px-4 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <a
              href="https://drive.google.com/file/d/1u_FNY467B4eW_rTj-YjxIwlMFYHt3XdD/view?usp=sharing"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center mt-4 px-3 py-1.5 rounded-md text-xs text-white/40 hover:text-white/70 border border-white/10 hover:border-white/20 transition-colors"
            >
              Voir les planches UX en HD
            </a>
          </div>
