import { Clock, CheckCircle2, FileText, Download, ShieldCheck } from "lucide-react";
...
const SupplierPendingScreen = ({ accountStatus, contractStatus, userName, onSimulateApproval }: Props) => {
