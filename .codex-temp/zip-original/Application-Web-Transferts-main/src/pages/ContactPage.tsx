              ...
              <div className="p-10 lg:p-14 bg-card">
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <Button
                    type="submit"
                    disabled={loading}
                    className="w-full h-12 rounded-xl text-sm font-semibold bg-gradient-to-r from-primary via-accent to-destructive/80 hover:opacity-90 text-white shadow-button transition-all duration-300"
                  >
