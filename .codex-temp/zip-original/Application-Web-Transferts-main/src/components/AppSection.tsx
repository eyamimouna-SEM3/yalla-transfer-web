...
import mockupPhonesDuo from "@/assets/mockup-phones-duo.png";
        ...
        <div className="bg-card rounded-3xl p-8 sm:p-12 shadow-card-hover border border-border/60 overflow-hidden relative hover:shadow-2xl transition-shadow duration-500">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-center relative z-10">
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="w-28 h-28 bg-muted rounded-xl flex items-center justify-center border border-border hover:border-primary/30 transition-colors">
            ...
            <div className="lg:col-span-1 flex justify-center lg:justify-end relative">
              <img
                ...
                className="w-80 lg:w-[22rem] h-auto drop-shadow-2xl hover:scale-105 transition-all duration-500 object-contain lg:-my-16"
              />
            </div>
          </div>
        </div>
