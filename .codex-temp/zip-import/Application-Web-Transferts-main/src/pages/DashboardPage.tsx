...
const DashboardPage = () => {
  ...
  // Mutable supplier status for dev simulation
  const [accountStatus, setAccountStatus] = useState(state?.accountStatus || "active");
  const [contractStatus, setContractStatus] = useState<"none" | "sent" | "signed" | "validated">(
    (state?.contractStatus || "validated") as "none" | "sent" | "signed" | "validated"
  );
