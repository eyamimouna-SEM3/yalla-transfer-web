...
const FormChauffeur = ({ name, email, onBack }: Props) => {
  ...
  if (success) {
    return (
      <div className="text-center py-12">
        ...
        <Button
          onClick={() => navigate("/dashboard", { state: { profile: "chauffeur", name: chauffeur.nom, accountStatus: "active", contractStatus: "validated" } })}
          variant="outline"
