...
const StepProfileForm = ({ profile, name, email, password, onBack }: Props) => {
  if (profile === "particulier") {
    return <FormParticulier name={name} email={email} password={password} onBack={onBack} />;
  }
  if (profile === "corporate") {
    return <FormCorporate name={name} email={email} password={password} onBack={onBack} />;
  }
  if (profile === "transport") {
    return <FormTransport name={name} email={email} password={password} onBack={onBack} />;
  }
  if (profile === "chauffeur") {
    return <FormChauffeur name={name} email={email} password={password} onBack={onBack} />;
  }
  return null;
};
