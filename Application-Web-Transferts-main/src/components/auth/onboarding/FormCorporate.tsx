...
const FormCorporate = ({ name, email, password: _password, onBack }: Props) => {
  ...
  const isValid =
    ...
    form.telephonePro.trim().length >= 6;
    ...
    <div>
      ...
      <div className="bg-background rounded-2xl border border-border p-6 sm:p-8 space-y-5 mb-6">
        ...
        <div>
          ...
          <Input type="tel" value={form.telephonePro} onChange={set("telephonePro")} placeholder="+216 XX XXX XXX" className="h-12 rounded-xl" />
        </div>
