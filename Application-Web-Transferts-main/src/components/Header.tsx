        ...
        <div className="container mx-auto flex items-center justify-between h-16 px-4 lg:px-8">
          ...
          <div className="hidden lg:flex items-center gap-2.5">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="min-w-[160px] rounded-xl shadow-lg border-border/60">
                {currencies.map((c) => (
                  <DropdownMenuItem
                    key={c.code}
                    onClick={() => setCurrency(c.code)}
                    className={`cursor-pointer rounded-lg ${currency === c.code ? "bg-primary/10 text-primary font-semibold" : ""}`}
                  >
