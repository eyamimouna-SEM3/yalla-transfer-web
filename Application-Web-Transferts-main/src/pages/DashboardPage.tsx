...
const DashboardPage = () => {
  ...
  const roleToProfile: Record<string, ProfileType> = {
    user: "particulier",
    provider: "transport",
    admin: "particulier",
  };
  const profile: ProfileType =
    state?.profile || roleToProfile[storedUser?.role || ""] || "particulier";
  const userName = state?.name || storedUser?.fullName || "Utilisateur";
